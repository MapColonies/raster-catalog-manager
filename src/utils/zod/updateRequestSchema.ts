...
import { IRasterCatalogEditRequestBody, VALIDATIONS } from '@map-colonies/mc-model-types';
...
export const validateUpdatableFields = (data: unknown): IRasterCatalogEditRequestBody => {
